...
var SlateEditor = function (_Component) {
  ...
  function SlateEditor(props) {
    ...
    _this.state = { state: _initialEditorState2.default, readOnly: false };
    return _this;
  }
  ...
  _createClass(SlateEditor, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: (0, _classnames2.default)("editor--root", className) },
        _Utils2.default.cloneElement(children, childProps)
      );
    }
  }]);

...
var reapplyMark = exports.reapplyMark = function reapplyMark(_ref) {
  var state = _ref.state,
      rgba = _ref.rgba;
  return state.transform().removeMark(getMark(state)).addMark(createMark(rgba)).apply();
};

var applyMark = exports.applyMark = function applyMark(_ref2) {
  var state = _ref2.state,
      rgba = _ref2.rgba;
  return state.transform().addMark(createMark(rgba)).apply();
};
...
var ColorUtils = {
  ...
  reapplyMark: reapplyMark,
  applyMark: applyMark,
  colorMarkStrategy: colorMarkStrategy
};

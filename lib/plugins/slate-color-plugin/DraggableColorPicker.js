...
if (process.env.REACT_APP_BROWSER || process.env.BROWSER) require('./DraggableColorPicker.css');
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(_reactColor.SketchPicker, {
        ...
        onChangeComplete: function onChangeComplete(color) {
          ...
          changeState({
            state: (0, _ColorUtils.colorMarkStrategy)({ state: state, rgba: rgbaChange }),

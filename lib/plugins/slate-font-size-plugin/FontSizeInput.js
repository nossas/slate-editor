...
var FontSizeInput = function FontSizeInput(_ref) {
  ...
  return _react2.default.createElement('input', {
    onKeyDown: function onKeyDown(_ref2) {
      ...
      if (isEnter) changeState({ fontSize: fontSize, state: (0, _FontSizeUtils.fontSizeStrategy)({ state: state, fontSize: fontSize, changeState: changeState }) });else changeState({ fontSize: fontSize, state: state });
    },

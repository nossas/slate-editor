  ...
  return _react2.default.createElement(
    _button.Button,
    {
      ...
      onClick: function onClick(e) {
        return onChange((0, _GridUtils.appendGrid)(value.change()));
      },
      className: (0, _classnames2.default)('slate-grid-plugin--button', { active: (0, _GridUtils.hasGrid)(value) }, className)
    },

      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'button',
          {
            ...
            onClick: function onClick(e) {
              _reactDom2.default.findDOMNode(_this2.upload).click();
            }
          },
        ...
        _react2.default.createElement(_reactS3Uploader2.default, {
          ...
          onError: function onError(e) {
            return console.error('[SlateEdit][ImagePlugin]:', e);
          },
          onFinish: function onFinish(e) {
            var src = e.signedUrl.substring(0, e.signedUrl.indexOf('?'));
            onChange((0, _ImageUtils.insertInlineImage)({ state: state, src: src }));

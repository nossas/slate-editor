          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              { onSubmit: function onSubmit(e) {
                  e.preventDefault();
                  onChange((0, _ImageUtils.updateInlineImage)({ change: state.change(), data: _this2.state.imageAttributes }));
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(_modal.ModalButton.Danger, {
                  ...
                  onClick: function onClick(e) {
                    e.preventDefault();
                    e.stopPropagation();
                    onChange((0, _ImageUtils.deleteInlineImage)({ change: state.change() }));
                  }
                })
              )
            )

  ...
  return _react2.default.createElement(
    _button.Button,
    {
      ...
      onClick: function onClick(e) {
        return onChange((0, _ItalicUtils.italicMarkStrategy)(value.change()));
      },
      className: (0, _classnames2.default)('slate-italic-plugin--button', { active: (0, _ItalicUtils.hasMark)(value) }, className)
    },

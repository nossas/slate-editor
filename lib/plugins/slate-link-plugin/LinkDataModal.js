          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              { onSubmit: function onSubmit(e) {
                  ...
                  if (_this2.isValidHref(imageAttributes.href)) {
                    var href = imageAttributes.href;

                    var hasProtocol = /^https?:\/\/.+/.test(href);
                    console.log('imageAttributes', imageAttributes);
                    onChange((0, _LinkUtils.updateLinkStrategy)({ state: state, data: _extends({}, imageAttributes, {
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(_modal.ModalButton.Opaque, {
                  ...
                  onClick: function onClick() {
                    if (!node.data.get('href')) onChange((0, _LinkUtils.unlink)(state));
                    changeModalState(false);
                  }
                }),

...
var LinkNode = function (_Component) {
  ...
  _createClass(LinkNode, [{
    ...
    value: function render() {
      ...
      var focusedOnCurrentNode = (0, _LinkUtils.getLink)(state) && node.key === (0, _LinkUtils.getLink)(state).key;
      var showTooltip = !readOnly && state.isCollapsed && focusedOnCurrentNode;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          showTooltip && _react2.default.createElement(
            _tooltip2.default,
            { style: { display: (0, _LinkUtils.hasLinks)(state) ? 'block' : 'none' } },
            _react2.default.createElement(
            ...
            _react2.default.createElement(
              _tooltip2.default.Item,
              { onClick: function onClick() {
                  return onChange((0, _LinkUtils.unlink)(state));
                } },
              'Unlink'
            )
          ),

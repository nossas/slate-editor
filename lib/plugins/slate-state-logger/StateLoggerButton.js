    ...
    _react2.default.createElement(
      'button',
      {
        ...
        onMouseDown: function onMouseDown(e) {
          e.preventDefault();
          console.info('RawState SlateJS', _slate.Raw.serialize(state));
          console.info('Raw.serialize(state)', (0, _jsonBeautify2.default)(_slate.Raw.serialize(state), null, 2, 100));
        }
      },

  ...
  return _react2.default.createElement(
    _button.Button,
    {
      ...
      onClick: function onClick(e) {
        return onChange((0, _StrikethroughUtils.strikethroughMarkStrategy)(state.change()));
      },
      className: (0, _classnames2.default)('slate-strikethrough-plugin--button', { active: (0, _StrikethroughUtils.hasMark)(state) }, className)
    },

  ...
  return _react2.default.createElement(
    _button.Button,
    {
      ...
      onClick: function onClick(e) {
        return onChange((0, _UnderlineUtils.underlineMarkStrategy)(value.change()));
      },
      className: (0, _classnames2.default)('slate-underline-plugin--button', { active: (0, _UnderlineUtils.hasMark)(value) }, className)
    },
